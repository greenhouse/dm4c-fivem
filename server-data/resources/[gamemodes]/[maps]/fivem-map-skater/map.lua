...
-- ---------------------------------------------------------- --
-- spawnpoint 'a_m_y_skater_01' { x = -1250.0, y = -400.0, z = 13.0 } -- Center of Vespucci Beach
-- spawnpoint 'a_m_y_skater_02' { x = -1300.0, y = -450.0, z = 13.5 } -- Beachfront near skatepark
-- spawnpoint 'a_m_y_skater_01' { x = -1200.0, y = -350.0, z = 14.0 } -- Near Venice Blvd
-- spawnpoint 'a_m_y_skater_02' { x = -1275.0, y = -500.0, z = 12.8 } -- South beach area
-- spawnpoint 'a_m_y_skater_01' { x = -1225.0, y = -300.0, z = 15.0 } -- Inland near Bay City Ave
-- spawnpoint 'a_m_y_skater_02' { x = -1325.0, y = -375.0, z = 13.2 } -- Near Venice Canals
-- spawnpoint 'a_m_y_skater_01' { x = -1150.0, y = -425.0, z = 14.5 } -- Inland near Washington Ave
-- spawnpoint 'a_m_y_skater_02' { x = -1280.0, y = -320.0, z = 14.0 } -- Near Venice Way
-- spawnpoint 'a_m_y_skater_01' { x = -1180.0, y = -480.0, z = 13.0 } -- South inland
-- spawnpoint 'a_m_y_skater_02' { x = -1240.0, y = -360.0, z = 13.8 } -- Central beach area

-- spawnpoint 'a_m_y_skater_01' { x = -1250.0, y = -400.0, z = 80.0 }  -- Beach center
-- spawnpoint 'a_m_y_skater_02' { x = -1300.0, y = -450.0, z = 80.0 }  -- Near skatepark
-- spawnpoint 'a_m_y_skater_01' { x = -1200.0, y = -350.0, z = 80.0 }  -- Venice Blvd
-- spawnpoint 'a_m_y_skater_02' { x = -1275.0, y = -500.0, z = 80.0 }  -- South beach
-- spawnpoint 'a_m_y_skater_01' { x = -1225.0, y = -300.0, z = 80.0 }  -- Bay City Ave
-- spawnpoint 'a_m_y_skater_02' { x = -1325.0, y = -375.0, z = 80.0 }  -- Venice Canals
-- spawnpoint 'a_m_y_skater_01' { x = -1150.0, y = -425.0, z = 80.0 }  -- Washington Ave
-- spawnpoint 'a_m_y_skater_02' { x = -1280.0, y = -320.0, z = 80.0 }  -- Venice Way
-- spawnpoint 'a_m_y_skater_01' { x = -1180.0, y = -480.0, z = 80.0 }  -- South inland
-- spawnpoint 'a_m_y_skater_02' { x = -1240.0, y = -360.0, z = 80.0 }  -- Central beach
